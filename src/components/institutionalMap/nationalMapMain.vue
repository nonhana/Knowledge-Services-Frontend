<template>
  <div name="nationalMapMain" class="nationalMapMain-wrap">
    ...
    <el-row style="width: 90%; margin: 30px 0 0 0">
    ...
    <el-row style="width: 90%; padding: 30px">
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column prop="name" label="法律级别" width="100" />
        <el-table-column prop="address" label="名称" width="210" />
        <el-table-column prop="address" label="发文单位" width="150" />
        <el-table-column prop="address" label="业务类别" width="150" />
