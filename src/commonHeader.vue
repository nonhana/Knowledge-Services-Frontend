    ...
    <div class="flex ml-20px">
      ...
      <div class="ml-50px items">
        ...
        <svg
          ...
          style="fill: rgba(255, 255, 255, 1)"
        >
          <path d="M15.942 25.6l-10.609-18.624h21.333z" />
        </svg>
      </div>
      <div
        class="ml-100px items"
        @click="moveLine(4)"
        @mouseenter="moveLine(0)"
        @mouseleave="moveLine(3)"
      >
        <span>应用概览</span>
      </div>
      <div
